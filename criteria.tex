...
6 & DIQ Uniformity& The ''System'' contribution to the measured Delivered Image Quality can vary over the field of view such that 10$\%$ or less of the FOV has a system contribution of up to 0.52$\arcsec$ (see LSST system specifications LSR-REQ-0008.  & \makecell[l]{\\Currently\\ not meeting \\for typical\\images\\}\\\hline
...
This leaves ''The Big 3'' -- Delivered Image Quality (optics + dome environment) and Normalized \'{E}tendue.
