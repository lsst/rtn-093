...
The criteria articulated below are meant only to provide gating guidance signifying the survey start. There will likely be key processes within the overall system, including data management and processing where further work for improvments are required or desired after handover (beyond the construction project requirements). Unless these would prevent yjr acquisition and saving of science qquality data, thereby delaying the survey start, they are not discussed or enumerated here.  These and other criteria (TBD) will be used to gage and moniter the overall performance of the Observatory and progress towards the 10-year survey objectives going forware, with nominal $T=0$ defined by when start criteria described herein are met.
